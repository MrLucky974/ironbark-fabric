package io.github.mrlucky974.ironbark.world.chunk;
...
public class ChunkOres extends ConcurrentHashMap<Vec3i, ChunkBlockConfig> {
     ...
     */
    public void processConfig(Vec3i pos, ChunkBlockConfig conf, boolean localPos) {
